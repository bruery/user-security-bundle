...
use Bruery\CoreBundle\Exception\SettingsManagerException;

class AbstractSettingsManager implements SettingsManagerInterface
{
    /** @var array */
    protected $configs;
    protected $options;
    ...
    public function getConfig($name)
    {
        if (!$this->hasConfig($name)) {
            throw SettingsManagerException::configDoesNotExist($name);
        }
    ...
    public function getOption($name)
    {
        if (!$this->hasOption($name)) {
            throw SettingsManagerException::optionDoesNotExist($name);
        }
    ...
    public function getIndex($name)
    {
        if (!$this->hasIndex($name)) {
            throw SettingsManagerException::indexDoesNotExist($name);
        }
