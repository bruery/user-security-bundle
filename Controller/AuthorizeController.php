...
namespace Bruery\OAuthServerBundle\Controller;
...
class AuthorizeController extends BaseController
{
    ...
    public function authorizeAction(Request $request)
    {
        ...
        return $this->container->get('templating')->renderResponse(
            'BrueryOAuthServerBundle:Authorize:authorize.html.'.$this->container->getParameter('fos_oauth_server.template.engine'),
            array(
